...
function getPro(){
    ...
    while($row_service=mysqli_fetch_array($run_service)){
        ...
        $pro_price = $row_service['service_price'];
        
        $pro_img1 = $row_service['s_image'];
        ...
        <div class="col-md-4 col-sm-6 single">
            ...
            <div class="service">
                ...
                <a href="details.php?pro_id=$service_id">
...
function total_price(){
    ...
    while($record=mysqli_fetch_array($run_cart)){
        ...
        $pro_id = $record['service_id'];
        
     
        
        $get_price = "select * from services where service_id='$pro_id'";
        
        $run_price = mysqli_query($db,$get_price);
        
        while($row_price=mysqli_fetch_array($run_price)){
            
            $sub_total = $row_price['service_price'];
